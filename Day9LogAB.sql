...
ERROR 1054 (42S22): Unknown column 'Bull' in 'where clause'
MariaDB [csd2204s18]> select salary from employees where last_name like 'Bull';
+---------+
| salary  |
+---------+
...
MariaDB [csd2204s18]> select first_name from employees where COMPARE IN (employee_id,manager_id);
ERROR 1054 (42S22): Unknown column 'COMPARE' in 'where clause'
MariaDB [csd2204s18]> select first_name from employees IN (employee_id,manager_id);
ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near 'IN (employee_id,manager_id)' at line 1
MariaDB [csd2204s18]> select first_name from employees LIKE IN (employee_id,manager_id);
ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near 'LIKE IN (employee_id,manager_id)' at line 1
...
MariaDB [csd2204s18]> select job_id,min_salary from jobs WHERE (select first_name,last_name, salary, job_id from employees);
ERROR 1241 (21000): Operand should contain 1 column(s)
MariaDB [csd2204s18]> select job_id,min_salary from jobs IN(select first_name,last_name, salary, job_id from employees);
ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near 'IN(select first_name,last_name, salary, job_id from employees)' at line 1
