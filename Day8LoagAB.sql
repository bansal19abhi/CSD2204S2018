...
MariaDB [csd2204s18]> decs manu;
ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near 'decs manu' at line 1
MariaDB [csd2204s18]> desc mnu;
...
MariaDB [csd2204s18]> SELECT manufacturer, m.name, co==COUNT(*) "No. of items produced" From products as p INNE
    -> ;
ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near '=COUNT(*) "No. of items produced" From products as p INNE' at line 1
MariaDB [csd2204s18]> SELECT manufacturer, m.name, co==COUNT(*) "No. of items produced" From products as p INNER join manu m on m.code=p.manufacturer group by manufacturer;
ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near '=COUNT(*) "No. of items produced" From products as p INNER join manu m on m.code' at line 1
